...
public class Constants {
    ...
    public static final double PURPLE_RED_PERCENTAGE = 24.3;
    public static final double PURPLE_GREEN_PERCENTAGE = 27.3;
    public static final double PURPLE_BLUE_PERCENTAGE = 48.4;
    public static final double GREEN_RED_PERCENTAGE = 11;
    public static final double GREEN_GREEN_PERCENTAGE = 53.6;
    public static final double GREEN_BLUE_PERCENTAGE = 35.4;
    public static final double ERROR_THRESHOLD = 15.0;

    public static final int BLUE_GOAL_COLOR = 20;
    public static final int RED_GOAL_COLOR = 24;
