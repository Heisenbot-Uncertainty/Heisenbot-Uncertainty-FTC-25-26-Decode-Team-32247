...
public class TeleOpMain extends LinearOpMode {
    ...
    public void targetToggle() {
        if (gamepad2.yWasPressed() && targetID == 20) {
            targetID = 24;
        } else if (gamepad2.yWasPressed() && targetID == 24) {
            targetID = 20;
        }
            if (targetID == 20) {
    ...
    public void debugToggle() {
        if ((gamepad1.aWasPressed() || gamepad2.aWasPressed()) && debugMode == false) {
            debugMode = true;
        }
        if ((gamepad1.aWasPressed() || gamepad2.aWasPressed()) && debugMode == true) {
            debugMode = false;
        }
        if (debugMode = false) {
        }
